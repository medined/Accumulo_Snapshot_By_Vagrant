...
test -z "$HADOOP_HOME"           && export HADOOP_HOME=$HOME/accumulo_home/bin/hadoop
test -z "$HADOOP_PREFIX"         && export HADOOP_PREFIX=$HOME/accumulo_home/bin/hadoop
test -z "$ZOOKEEPER_HOME"        && export ZOOKEEPER_HOME=$HOME/accumulo_home/bin/zookeeper
